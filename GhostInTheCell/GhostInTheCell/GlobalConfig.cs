...
public static class GlobalConfig {
    public static double LinkDistance_PenaltyCoef_15    = 0.3f;
    public static double LinkDistance_PenaltyCoef_10    = 0.085f;
    public static double LinkDistance_PenaltyCoef_other = 0.0f;
